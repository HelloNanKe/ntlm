...
public class NTLMScheme extends AuthSchemeBase {
    ...
    protected void parseChallenge(
        ...
        if (this.challenge.length() == 0) {
            ...
            } else if (this.state == NTLMScheme.State.MSG_TYPE1_GENERATED) {
    ...
    public Header authenticate(
        ...
        } else if (this.state == NTLMScheme.State.CHALLENGE_RECEIVED) {
            response = this.engine.generateType1Msg(
                    ntcredentials.getDomain(),
                    ntcredentials.getWorkstation());
            this.state = NTLMScheme.State.MSG_TYPE1_GENERATED;
        } else if (this.state == NTLMScheme.State.MSG_TYPE2_RECEVIED) {
