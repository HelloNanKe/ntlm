package com.zt.ntlm.service.impl;
...
public class NTLMEngineImpl implements NTLMEngine {
     ...
     * @return The response.
     * @throws org.apache.http.HttpException If the messages cannot be retrieved.
     */
    ...
    String getType3Message(final String user, final String password, final String host, final String domain,
        ...
        return new NTLMEngineImpl.Type3Message(domain, host, user, password, nonce, type2Flags, target,
     ...
     */
    public static class Type2Message extends NTLMEngineImpl.NTLMMessage {
        protected byte[] challenge;
        protected String target;
        protected byte[] targetInfo;
        protected int flags;

        public Type2Message(final String message) throws NTLMEngineException {
            super(message, 2);
    ...
    static class Type3Message extends NTLMEngineImpl.NTLMMessage {
        ...
        Type3Message(final String domain, final String host, final String user, final String password, final byte[] nonce,
            ...
            final NTLMEngineImpl.CipherGen gen = new NTLMEngineImpl.CipherGen(unqualifiedDomain, user, password, nonce, target, targetInformation);
    ...
    public String generateType3Msg(
        ...
        final Type2Message t2m = new NTLMEngineImpl.Type2Message(challenge);
